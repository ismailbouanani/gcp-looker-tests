# The name of this view in Looker is "V Fact Xca Delivery"
view: v_fact_xca_delivery {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp_p_mo_da_azure_datalake_bqdataset01.v_fact_xca_delivery`
    ;;
  ...
  dimension: dwh_delivery_id {
    type: number
    sql: ${TABLE}.DWH_DELIVERY_ID ;;
  }
  ...
  dimension: personalised_mailing {
    type: number
    sql: ${TABLE}.PERSONALISED_MAILING ;;
  }
