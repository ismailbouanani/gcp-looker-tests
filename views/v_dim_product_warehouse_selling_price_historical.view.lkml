# The name of this view in Looker is "V Dim Product Warehouse Selling Price Historical"
view: v_dim_product_warehouse_selling_price_historical {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp_p_mo_da_azure_datalake_bqdataset01.v_dim_product_warehouse_selling_price_historical`
    ;;
  ...
  dimension: dwh_product_warehouse_selling_price_historical_id {
    type: number
    description: "technical unique key"
    sql: ${TABLE}.DWH_PRODUCT_WAREHOUSE_SELLING_PRICE_HISTORICAL_ID ;;
  }
  ...
  dimension: product_selling_price {
    type: number
    description: "product selling price (! DOES NOT INCLUDE PROMOTION!) between start _date and end_date"
  ...
  measure: total_product_selling_price {
    type: sum
    sql: ${product_selling_price} ;;
  }

  measure: average_product_selling_price {
    type: average
    sql: ${product_selling_price} ;;
  }
