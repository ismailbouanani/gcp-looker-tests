# The name of this view in Looker is "V Fact Mgb Digital Smkt Sales"
view: v_fact_mgb_digital_smkt_sales {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp_p_mo_da_azure_datalake_bqdataset01.v_fact_mgb_digital_smkt_sales`
    ;;
