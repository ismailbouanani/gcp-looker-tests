# The name of this view in Looker is "V Fact Xca Openers"
view: v_fact_xca_openers {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp_p_mo_da_azure_datalake_bqdataset01.v_fact_xca_openers`
    ;;
  ...
  dimension: dwh_openers_id {
    type: number
    sql: ${TABLE}.DWH_OPENERS_ID ;;
  }
