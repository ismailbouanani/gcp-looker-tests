# The name of this view in Looker is "V Fact Xca Unsubscribes"
view: v_fact_xca_unsubscribes {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gcp_p_mo_da_azure_datalake_bqdataset01.v_fact_xca_unsubscribes`
    ;;
  ...
  dimension: dwh_unsubscribes_id {
    type: number
    sql: ${TABLE}.DWH_UNSUBSCRIBES_ID ;;
  }
  ...
  dimension: unsubscribe_source {
    type: string
    sql: ${TABLE}.UNSUBSCRIBE_SOURCE ;;
  }
  ...
  measure: unsubscribing_customers {
